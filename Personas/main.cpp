...
//    QCoreApplication a(argc, argv);
    ...
    shared_ptr<cProfesor> p1 = make_shared<cProfesor>("Alberto",33,509829,3000);
    shared_ptr<cProfesor> p2 = make_shared<cProfesor>("Wilfredo",30,554235,2345);

    shared_ptr<cEstudiante> e1 = make_shared<cEstudiante>("Rafael", 34, 495822,4.2);
    shared_ptr<cEstudiante> e2 = make_shared<cEstudiante>("Randy", 30, 4564,0);
    shared_ptr<cEstudiante> e3 = make_shared<cEstudiante>("Claudia", 26, 78868,3.1);
